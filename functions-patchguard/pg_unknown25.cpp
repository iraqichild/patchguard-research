/* XREFS 
Down	o	pg_main+3051	lea     rax, pg_unknown25
*/

__int64 __fastcall pg_unknown25(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v4; // r9
  __int64 v7; // rdx
  int v8; // ecx
  ...
  result = MmSetPageProtection(v19, (v18[10] + 4095 + ((v18[8] + v18[11]) & 0xFFF)) & 0xFFFFF000, 64LL);
  *(_QWORD *)(a1 + 40) = 0LL;
  *(_QWORD *)(a1 + 32) = a3;
  return result;
}